...
PLATFORM="iPhoneOS"  
INSTALL="FFmpeg-thin-iOS"  
SDK_VERSION="9.3"  
  
# libx264  
export X264ROOT=../x264-thin-iOS/arm64  
...
make clean  
./configure \
--extra-cflags='-I$X264INCLUDE -arch arm64 -miphoneos-version-min=5.0 -mthumb' \
--extra-ldflags='-L$X264LIB -arch arm64 -miphoneos-version-min=5.0' \
--enable-cross-compile \
--arch=arm64 --disable-iconv \
--target-os=darwin \
--cc=${CC} --disable-asm \
--sysroot=${SDKROOT} \
--prefix=../${INSTALL}/arm64 --enable-pthreads \
